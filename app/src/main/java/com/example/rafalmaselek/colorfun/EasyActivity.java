...
public class EasyActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mCountDownTimer=new CountDownTimer(30000,1000)
        {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(EasyActivity.this, ResultsActivity.class);
    ...
    private void randomizeColors()
    {
        ...
        bt1bd1.setBackgroundColor(getResources().getColor(colorRefList[currentColors.get(0)]));
        bt1bd2.setBackgroundColor(getResources().getColor(colorRefList[currentColors.get(0)]));
        bt1bd3.setBackgroundColor(getResources().getColor(colorRefList[currentColors.get(0)]));
        bt1bd4.setBackgroundColor(getResources().getColor(colorRefList[currentColors.get(0)]));
        ...
        bt2bd1.setBackgroundColor(getResources().getColor(colorRefList[currentColors.get(1)]));
        bt2bd2.setBackgroundColor(getResources().getColor(colorRefList[currentColors.get(1)]));
        bt2bd3.setBackgroundColor(getResources().getColor(colorRefList[currentColors.get(1)]));
        bt2bd4.setBackgroundColor(getResources().getColor(colorRefList[currentColors.get(1)]));
        ...
        bt3bd1.setBackgroundColor(getResources().getColor(colorRefList[currentColors.get(2)]));
        bt3bd2.setBackgroundColor(getResources().getColor(colorRefList[currentColors.get(2)]));
        bt3bd3.setBackgroundColor(getResources().getColor(colorRefList[currentColors.get(2)]));
        bt3bd4.setBackgroundColor(getResources().getColor(colorRefList[currentColors.get(2)]));
        ...
        bt4bd1.setBackgroundColor(getResources().getColor(colorRefList[currentColors.get(3)]));
        bt4bd2.setBackgroundColor(getResources().getColor(colorRefList[currentColors.get(3)]));
        bt4bd3.setBackgroundColor(getResources().getColor(colorRefList[currentColors.get(3)]));
        bt4bd4.setBackgroundColor(getResources().getColor(colorRefList[currentColors.get(3)]));
